...
@section('title', 'Manage Trucks Setting')
@section('content')
<style>
.required:after {
    content: '*';
...
<div class="row">
    ...
    @endif
    <div class="col-md-12">
        <h3 class="title-5 m-b-35">Manage Truck Settings </h3>
        <div class="table-data__tool">
            <div class="table-data__tool-right">
               
                    <button class="au-btn-filter mb-1 add_modal" data-toggle="modal" data-target="#addModal">
                        <i class="zmdi zmdi-plus"></i> Add Truck Setting
                    </button>
               
                    <input type="file" class="au-btn-filter">
                    <button class="au-btn-filter">
                        <i class="zmdi zmdi-upload"></i> Import Truck Setting
                    </button>
...
<script>
    $(document).ready(function(){
        table = $('#customer').DataTable({
                ...
                columns:[
                    { data: 'truck_id', className: "text td_ellipsis td-limit", title : 'Truck Id'},
                    { data: 'tax', className: "text td_ellipsis td-limit", title : 'Tax'},
                    { data: 'pickup_options', className: "text td_ellipsis td-limit", title : 'Pickup Options'},
                    { data: 'pickup_stations', className: "text td_ellipsis td-limit", title : 'Pickup Stations'},
                    { data: 'servers', className: "text td_ellipsis td-limit", title : 'Servers'},
                    { data: 'active', className: "text td_ellipsis td-limit", title : 'Status'},
                    { data: 'application_fees', className: "text td_ellipsis td-limit", title : 'Application Fees'},
                    { data: 'custom_fees', className: "text td_ellipsis td-limit", title : 'Custom Fees'},
                    { data: 'accept_cash_at_customer_app', className: "text td_ellipsis td-limit", title : 'Accept Cash At Customer App'},
                    { data: 'max_cash_amount_at_customer_app', className: "text td_ellipsis td-limit", title : 'Max Cash Amount At Customer App'},
                    { data: 'accept_card_at_customer_app', className: "text td_ellipsis td-limit", title : 'Accept Card At Customer App'},
                    { data: 'min_card_amount_at_customer_app', className: "text td_ellipsis td-limit", title : 'Min Card Amount At Customer_app'},
                    { data: 'accept_cash_at_merchant_app', className: "text td_ellipsis td-limit", title : 'Accept cash At Merchant App'},
